...
export const translations = {
  en: {
    ...
    privacy: {
      ...
      description: 'RunFps privacy policy — what little data we touch, including Google Analytics.',
      heading: 'Privacy Policy',
      lastUpdated: 'Last updated: September 2026',
      intro: 'Your hardware specs and calculations never leave your browser — that part has not changed. Since September 2026 we do measure anonymous visits with Google Analytics (see below), but only after you accept cookies.',
      ...
      local: 'Local Storage',
      localText: 'We use localStorage only to remember your dark mode preference and your cookie choice. This stays on your device and is not sent to any server.',
      noTracking: 'Analytics',
      noTrackingText: 'We use Google Analytics 4 to count visits and see which pages are popular. It sets cookies only if you click Accept in the cookie banner; if you decline, nothing is stored and visits are not tracked. You can change your mind anytime by clearing this site\'s data in your browser. Data is processed by Google — see https://policies.google.com/privacy. To opt out everywhere, use https://tools.google.com/dlpage/gaoptout.',
  ...
  de: {
    ...
    privacy: {
      ...
      description: 'RunFps Datenschutzerklärung — welche Daten wir anfassen, inklusive Google Analytics.',
      heading: 'Datenschutzerklärung',
      lastUpdated: 'Zuletzt aktualisiert: September 2026',
      intro: 'Deine Hardware-Daten und Berechnungen verlassen nie deinen Browser — das bleibt so. Seit September 2026 messen wir anonyme Besuche mit Google Analytics (siehe unten), aber nur wenn du Cookies akzeptierst.',
      ...
      localText: 'Wir verwenden localStorage nur für deine Dunkelmodus-Einstellung und deine Cookie-Auswahl. Das bleibt auf deinem Gerät.',
      noTracking: 'Analysen',
      noTrackingText: 'Wir nutzen Google Analytics 4, um Besuche zu zählen und zu sehen, welche Seiten beliebt sind. Cookies werden nur gesetzt, wenn du im Cookie-Banner auf Akzeptieren klickst; bei Ablehnung wird nichts gespeichert und Besuche nicht erfasst. Du kannst deine Wahl jederzeit ändern, indem du die Website-Daten deines Browsers löschst. Daten werden von Google verarbeitet — siehe https://policies.google.com/privacy. Abmeldung überall: https://tools.google.com/dlpage/gaoptout.',
  ...
  fr: {
    ...
    privacy: {
      ...
      description: 'Politique de confidentialité de RunFps — les rares données concernées, dont Google Analytics.',
      heading: 'Politique de confidentialité',
      lastUpdated: 'Dernière mise à jour : septembre 2026',
      intro: 'Ton matériel et tes calculs ne quittent jamais ton navigateur — ça ne change pas. Depuis septembre 2026, nous mesurons les visites anonymes avec Google Analytics (voir ci-dessous), mais seulement si tu acceptes les cookies.',
      ...
      localText: 'Nous utilisons localStorage uniquement pour ton mode sombre et ton choix de cookies. Cela reste sur ton appareil.',
      noTracking: 'Statistiques',
      noTrackingText: 'Nous utilisons Google Analytics 4 pour compter les visites et voir quelles pages sont populaires. Les cookies ne sont déposés que si tu cliques sur Accepter dans le bandeau ; en cas de refus, rien n\'est stocké et les visites ne sont pas suivies. Tu peux changer d\'avis à tout moment en effaçant les données du site dans ton navigateur. Données traitées par Google — voir https://policies.google.com/privacy. Désactivation globale : https://tools.google.com/dlpage/gaoptout.',
  ...
  es: {
    ...
    privacy: {
      ...
      description: 'Política de privacidad de RunFps — los pocos datos que tocamos, incluido Google Analytics.',
      heading: 'Política de privacidad',
      lastUpdated: 'Última actualización: septiembre de 2026',
      intro: 'Tu hardware y tus cálculos nunca salen de tu navegador — eso no cambia. Desde septiembre de 2026 medimos visitas anónimas con Google Analytics (ver abajo), pero solo si aceptas las cookies.',
      ...
      localText: 'Usamos localStorage solo para tu modo oscuro y tu elección de cookies. Permanece en tu dispositivo.',
      noTracking: 'Analíticas',
      noTrackingText: 'Usamos Google Analytics 4 para contar visitas y ver qué páginas son populares. Solo establece cookies si pulsas Aceptar en el aviso; si rechazas, no se guarda nada ni se rastrean visitas. Puedes cambiar de opinión cuando quieras borrando los datos del sitio en tu navegador. Datos procesados por Google — ver https://policies.google.com/privacy. Exclusión global: https://tools.google.com/dlpage/gaoptout.',
  ...
  pt: {
    ...
    privacy: {
      ...
      description: 'Política de privacidade RunFps — os poucos dados envolvidos, incluindo Google Analytics.',
      heading: 'Política de Privacidade',
      lastUpdated: 'Última atualização: setembro de 2026',
      intro: 'Teu hardware e cálculos nunca saem do teu navegador — isso não muda. Desde setembro de 2026 medimos visitas anônimas com Google Analytics (ver abaixo), mas só se aceitares cookies.',
      ...
      localText: 'Usamos localStorage só para tema escuro e tua escolha de cookies. Fica no teu aparelho.',
      noTracking: 'Analytics',
      noTrackingText: 'Usamos Google Analytics 4 para contar visitas e ver páginas populares. Só define cookies se clicares Aceitar no aviso; se recusares, nada é guardado nem visitas rastreadas. Podes mudar de ideias quando quiseres limpando dados do site no navegador. Dados processados pela Google — ver https://policies.google.com/privacy. Desativação global: https://tools.google.com/dlpage/gaoptout.',
